...
export const metadata: Metadata = {
  title: 'About Me - Flutter & Full-Stack Developer',
  description: 'Learn more about Rezuanul Islam Fahim - Professional Flutter & Full-Stack Developer with 7+ years experience in mobile app development, React/Next.js, Node.js, and Firebase.',
  keywords: [
    ...
    'Rezuanul Islam Fahim background'
  ],
  openGraph: {
    title: 'About Rezuanul Islam Fahim - Professional Flutter & Full-Stack Developer',
    description: 'Learn more about my 7+ years experience in Flutter, React, Node.js, and building production-ready applications.',
    url: 'https://www.rezuanulislamfahim.me/about',
    images: [
      {
        url: '/og-about.png',
        width: 1200,
        height: 630,
        alt: 'About Rezuanul Islam Fahim - Flutter & Full-Stack Developer',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.rezuanulislamfahim.me/about',
  },
};
